...
export { default as MediaGalleryElement } from './MediaGalleryElement';
...
export { default as FavoritesListElement } from './FavoritesListElement';
export { default as ProfileElement } from './ProfileElement';
